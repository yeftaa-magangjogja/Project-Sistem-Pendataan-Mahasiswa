...
@section('content')
                            ...
                            <form action="{{ route('dosenn.search') }}" method="GET" class="flex items-center">
                                ...
                                <div class="relative w-full">
                                    ...
                                    <input type="text" name="search" id="simple-search"
                                        ...
                                        placeholder="Cari berdasarkan Nama, NIP atau Kode Dosen" required>
                                </div>
                                <button type="submit"
                            ...
                            <tbody>
                                @foreach ($dosen as $dosen)
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <td class="px-4 py-3">{{ $dosen->kelas ? $dosen->kelas->name : 'Belum memiliki kelas' }}</td>
                                        ...
                                        <td class="flex items-center">
                                            <ul class="text-sm">
                                                <li>
                                                    <button
                                                        onclick="openUpdateModal('{{ $dosen->user_id }}', '{{ $dosen->kode_dosen }}', '{{ $dosen->nip }}', '{{ $dosen->name }}', '{{ $dosen->kelas_id }}', '{{ $dosen->user->username }}')"
            ...
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                ...
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <form id="updateDosenForm" action="" method="post">
                        ...
                        <div class="grid gap-4 mb-4 sm:grid-cols-2">
                            <div class="col-span-2">
                                <h4 class="text-lg font-semibold text-gray-900 dark:text-white">Edit Akun Dosen</h4>
                            </div>
                            <div>
                            ...
                            {{-- <hr class=" col-span-2 mt-4 mb-2 border-t border-gray-300 dark:border-gray-600"> --}}
                            <div class="col-span-2">
                                <h4 class="text-lg font-semibold text-gray-900 dark:text-white">Edit Data Dosen</h4>
                            </div>
                            <div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.openUpdateModal = function(user_id, kode_dosen, nip, name, kelas_id, username) {
