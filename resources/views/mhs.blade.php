...
@section('content')
    ...
    @if (Route::currentRouteName() == 'mhs.index' || Route::currentRouteName() == 'mhs.search')
        <!-- Mhs index -->
                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    <div
                        ...
                        <div class="w-full md:w-1/2">
                            <form action="{{ route('mhs.search') }}" method="GET" class="flex items-center">
                                ...
                                <div class="relative w-full">
                                    ...
                                    <input type="text" name="search" id="simple-search"
                                        ...
                                        placeholder="Cari berdasarkan Nama atau NIM Mahasiswa" required>
                                </div>
                                <button type="submit"
                        ...
                        <div
                            ...
                            <button id="tambahMhsBtn" type="button"
                            ...
                            <tbody>
                                @foreach ($mahasiswa as $mahasiswa)
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        {{-- <td class="px-4 py-3">{{ $mahasiswa->kelas_id }}</td> --}}
                                        <td class="px-4 py-3">
                                            {{ $mahasiswa->kelas ? $mahasiswa->kelas->name : 'Belum memiliki kelas' }}</td>
                                        <td class="px-4 py-3">{{ $mahasiswa->nim }}</td>
                                        <td class="px-4 py-3">{{ $mahasiswa->nama }}</td>
                                        <td class="px-4 py-3">{{ $mahasiswa->tempat_lahir }}</td>
                                        <td class="px-4 py-3">{{ $mahasiswa->tanggal_lahir }}</td>
                                        <td class="px-4 py-3">{{ $mahasiswa->edit }}</td>
                                        <td class="flex items-center">
                                            <ul class="text-sm">
                                                <li>
                                                    <button
                                                        onclick="openUpdateModal('{{ $mahasiswa->user_id }}', '{{ $mahasiswa->nim }}', '{{ $mahasiswa->nama }}', '{{ $mahasiswa->tempat_lahir }}', '{{ $mahasiswa->tanggal_lahir }}', '{{ $mahasiswa->kelas_id }}', '{{ $mahasiswa->kelas_id }}', '{{ $mahasiswa->user->username }}')"
                                                ...
                                                <li>
                                                    <button onclick="openDeleteModal('{{ $mahasiswa->id }}')"
        ...
        <!-- Create modal -->
        <div id="createMhsModal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <div
                        ...
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Tambah Mahasiswa Baru</h3>
                        <button type="button"
                        ...
                        <div class="grid gap-4 mb-4 sm:grid-cols-2">
                            ...
                            <div class="col-span-2">
                                ...
                                <input type="number" name="nim" id="nim"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Contoh : 2202020" required>
                            </div>
                            <div class="col-span-2">
                                <label for="nama"
                                ...
                                <input type="text" name="nama" id="nama"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Contoh : Maria Ine" required>
                            </div>
                            <div>
                                ...
                                <input type="text" name="tempat_lahir" id="tempat_lahir"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Contoh : Kebumen" required>
                            </div>
                            <div>
                                <label for="name"
                                ...
                                <input type="date" name="tanggal_lahir" id="tanggal_lahir"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Contoh : 02/29/2000" required>
                            </div>
        ...
        <!-- Update modal -->
        <div id="updateMhsModal" tabindex="-1" aria-hidden="true"
            class="hidden overflow-y-auto overflow-x-hidden fixed inset-0 z-50 flex justify-center items-center w-full h-full bg-gray-900 bg-opacity-50">
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                <!-- Modal content -->
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <div
                        class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Update Mahasiswa</h3>
                        <button type="button"
                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
                    ...
                    <!-- Modal body -->
                    <form id="updateMhsForm" action="" method="POST">
                        @csrf
                        @method('POST')
                        <div class="grid gap-4 mb-4 sm:grid-cols-2">
                            <div class="col-span-2">
                                <h4 class="text-lg font-semibold text-gray-900 dark:text-white">Edit Akun Mahasiswa</h4>
                            </div>
                            <div>
                            ...
                            <div>
                                <label for="update_new_password"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Password Baru
                                    (Opsional)</label>
                                <input type="password" name="new_password" id="update_password"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            </div>
                            <div class="col-span-2">
                                <h4 class="text-lg font-semibold text-gray-900 dark:text-white">Edit Data Mahasiswa</h4>
                            </div>
                            <div>
                                <label for="update_user_id"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">User ID</label>
                                <input type="number" name="user_id" id="update_user_id"
                            ...
                            <div>
                                ...
                                <input type="number" name="kelas_id" id="update_kelas_id"  value="{{ $mahasiswa->kelas_id ? $mahasiswa->kelas->nama : 'Belum memiliki kelas' }}"
                                    class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    disabled>
                            </div>
                            <div>
                                <label for="update_nim"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">NIM</label>
                                <input type="text" name="nim" id="update_nim" value="{{ $mahasiswa->nim }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    required>
                            </div>
                            <div>
                                <label for="update_nama"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama</label>
                                <input type="text" name="nama" id="update_nama" value="{{ $mahasiswa->nama }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    required>
                            </div>
                            <div class="col-span-2">
                                <label for="update_tempat_lahir"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tempat
                                    Lahir</label>
                                <input type="text" name="tempat_lahir" id="update_tempat_lahir"
                            ...
                            <div class="col-span-2">
                                <label for="update_tanggal_lahir"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tanggal
                                    Lahir</label>
                                <input type="date" name="tanggal_lahir" id="update_tanggal_lahir"
        ...
        <!-- Delete modal -->
        <div id="deleteMhsModal" tabindex="-1" aria-hidden="true"
            class="hidden overflow-y-auto overflow-x-hidden fixed inset-0 z-50 flex justify-center items-center w-full h-full bg-gray-900 bg-opacity-50">
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <div class="flex justify-center items-center space-x-2 mt-4">
                        <form id="deleteMhsForm" method="POST" action="{{ route('mhs.destroy', $mahasiswa->id) }}">
                            @csrf
                            @method('DELETE')
                            <button type="button"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var tambahBtn = document.getElementById('tambahMhsBtn');
            var createModal = document.getElementById('createMhsModal');
            var updateModal = document.getElementById('updateMhsModal');
            var deleteModal = document.getElementById('deleteMhsModal');
            ...
            window.openUpdateModal = function(user_id, nim, nama, tempat_lahir, tanggal_lahir, id, kelas_id,
                username) {
                ...
                document.getElementById('update_tempat_lahir').value = tempat_lahir;
                document.getElementById('update_tanggal_lahir').value = tanggal_lahir;
                document.getElementById('update_kelas_id').value = kelas_id;
                document.getElementById('update_username').value = username;
                document.getElementById('updateMhsForm').action = '/mhs/' + nim;
                updateModal.classList.remove('hidden');
                updateModal.classList.add('flex');
            }

            window.openDeleteModal = function(id) {
                var form = document.getElementById('deleteMhsForm');
                form.action = '/mhs/' + id;
