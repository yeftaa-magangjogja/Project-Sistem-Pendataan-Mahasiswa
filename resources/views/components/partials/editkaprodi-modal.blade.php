<!-- Edit Kaprodi Modal -->
<div id="editKaprodiModal{{ Auth::user()->kaprodi->id }}" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto mx-auto mt-10">
        <!-- Modal content -->
        <form method="POST" action="{{ route('kaprodi.update', Auth::user()->kaprodi->id) }}">
            @csrf
            @method('PUT')
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                    ...
                    <button type="button"
                        ...
                        data-modal-hide="editKaprodiModal{{ Auth::user()->kaprodi->id }}">
                ...
                <div class="flex flex-col gap-4 mb-4">
                    <div>
                        ...
                        <input type="text" id="name" name="name"
                            ...
                            value="{{ Auth::user()->kaprodi->name }}" required>
                    </div>
                    <div>
                        ...
                        <input type="text" id="nip" name="nip"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            value="{{ Auth::user()->kaprodi->nip }}" required>
                    </div>
                    <div>
                        ...
                        <input type="text" id="kode_dosen" name="kode_dosen"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            value="{{ Auth::user()->kaprodi->kode_dosen }}" required>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-end space-x-4">
                    ...
                    <button type="button" data-modal-hide="editKaprodiModal{{ Auth::user()->kaprodi->id }}"
...
<script>
    document.addEventListener("DOMContentLoaded", function(event) {
        document.getElementById('editKaprodiButton').click();
    });
</script>