...
class MahasiswaRoleKaprodiController extends Controller
{
    ...
    public function updateMahasiswa(Request $request, $nim)
    {
        ...
        $data = $request->only(['nim', 'nama', 'tempat_lahir', 'tanggal_lahir', 'username']);
        ...
        try {
            ...
            $user = User::where('id', $mahasiswa->user_id)->firstOrFail();
            ...
            return redirect()->route('mhs.index')->withErrors('Terjadi kesalahan saat memperbarui data mahasiswa.');
        }
